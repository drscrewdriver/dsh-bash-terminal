    ...
    async execute(args, exec) {
      ...
      switch (args.action) {
        case "open": {
          ...
          // (gcc, make) never joins PATH. The inherited WSLENV is passed
          // explicitly (shellEnv.collect does not supply one) because buildEnv
          // layers the DSH keys onto it instead of rebuilding the allow-list.
